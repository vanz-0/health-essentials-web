...
2. Pick up your recommended products using your code
...
View your dashboard: https://1healthessentials.com/challenges/${userChallengeId}
...
To unsubscribe from challenge emails, reply with "unsubscribe".
    ...
    // Clean, transactional HTML for Primary inbox
    const emailHtml = `
<!DOCTYPE html>
<html>
<head>
