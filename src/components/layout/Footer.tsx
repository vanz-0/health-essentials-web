  ...
  return <footer className="border-t mt-24">
      <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 py-12">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li className="inline-flex items-center gap-2"><MapPin className="h-4 w-4" />Brentwood Arcade, Thindigua, Kiambu</li>
            <li className="inline-flex items-center gap-2"><Phone className="h-4 w-4" /> 0735558830</li>
            <li className="inline-flex items-center gap-2"><Mail className="h-4 w-4" />hello@1healt</li>
