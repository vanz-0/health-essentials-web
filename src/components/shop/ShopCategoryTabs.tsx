...
export default function ShopCategoryTabs({ 
  ...
  return (
    <>
      {/* Mobile Floating Button - Shows when collapsed on mobile */}
      <AnimatePresence>
        {isMobile && isCollapsed && currentCategory && (
          <motion.div
            initial={{ opacity: 0, y: -20, scale: 0.9 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: -20, scale: 0.9 }}
            transition={{ duration: 0.2 }}
            className="fixed top-[112px] right-4 z-50"
          >
            <Button 
              onClick={onBack}
              size="sm"
              className="rounded-full shadow-xl text-white border-0 backdrop-blur-sm"
      ...
      <section className={cn(
        ...
        !isMobile && "sticky top-[104px]",
        // Mobile: only sticky when not collapsed
        isMobile && !isCollapsed && "sticky top-[104px]",
        // Mobile collapsed: not sticky
        isMobile && isCollapsed && "relative"
      )}>
        ...
        {currentCategory && (
          <motion.div
            ...
            animate={{ 
              opacity: 1,
              height: !isMobile && isCollapsed ? 56 : 'auto'
            }}
            ...
            <AnimatePresence mode="wait">
              {!isMobile && isCollapsed ? (
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  transition={{ duration: 0.2 }}
                  className="container relative z-10 py-3"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="font-serifDisplay text-xl font-bold text-white drop-shadow-lg">
                ...
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  transition={{ duration: 0.2 }}
                  className="container relative z-10 py-8 md:py-12"
                >
